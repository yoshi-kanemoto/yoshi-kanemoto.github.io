...
#(1) set constants.
#
   $html_file0 = "./WorkingPapers_.html";     # prototype html file
   $html_file  = "./WorkingPapers.html";      # output html file with guest number
   $count_file = "./countwp.txt";       # guest number file
